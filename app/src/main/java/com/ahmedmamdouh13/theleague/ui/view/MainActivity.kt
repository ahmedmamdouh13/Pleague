...
//        else
//        {
        val controller = Controller(MatchesFragment(), FavoriteFragment(), supportFragmentManager)
        controller.firstIcon = R.drawable.ic_list_black_24dp
        controller.secondIcon = R.drawable.ic_favorite_black_24dp
